...
These applications and feature demonstrations are all available on Github at the [https://github.com/jsplumb-demonstrations](https://github.com/jsplumb-demonstrations) organisation - you can clone or degit any of them to use a base for a new application.
