import { filterBlur, filterBrightness, filterContrast, filterGrayScale, filterHueRotate, filterOpacity, filterSaturate, filterSepia, filterTint } from "@jsplumb/canvas-image-processing";
const filters = {
    set: "filter",
    name: "Filter",
    types: [
...
export const FILTER_INSPECTORS = {};
