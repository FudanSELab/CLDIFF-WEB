import { mirrorImage, blendImages, cropImage, overlayImage, imageThreshold, clipImage, resizeImage, AXIS_X } from '@jsplumb/canvas-image-processing';
...
export const TRANSFORM_INSPECTORS = {
    [TRANSFORM_MIRROR]: {
        template: (n) => `<label>Label:<input type="text" jtk-att="${ATTRIBUTE_LABEL}" jtk-focus placeholder="enter label"/></label>
