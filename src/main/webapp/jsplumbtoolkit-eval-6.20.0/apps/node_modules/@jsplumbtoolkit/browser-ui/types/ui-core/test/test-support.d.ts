...
import { BrowserElement } from "../browser-ui-renderer/index";
/**
...
export declare class BrowserUITestSupport {
     ...
     */
    addDiv(id: string, parent?: BrowserElement, className?: string, x?: number, y?: number, w?: number, h?: number): BrowserElement;
    addDivs(ids: Array<string>, parent?: BrowserElement): void;
    assertEndpointCount(el: BrowserElement, count: number): void;
    _assertManagedEndpointCount(el: BrowserElement, count: number): void;
    _assertManagedConnectionCount(el: BrowserElement, count: number): void;
     ...
     * @public
     */
    dragNodeBy(el: BrowserElement, x: number, y: number, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    dragNodeTo(el: BrowserElement, x: number, y: number, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    dragToGroup(el: BrowserElement, targetGroupId: string, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    aSyncDragNodeBy(el: BrowserElement, x: number, y: number, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    dragConnection(d1: Element | Endpoint<Element>, d2: Element | Endpoint<Element>, mouseUpOnTarget?: boolean, events?: EventHandlers<Connection<Element>>): Connection<Element>;
    /**
     ...
     * @public
     */
    aSyncDragConnection(d1: Element | Endpoint<BrowserElement>, d2: Element | Endpoint<BrowserElement>, events?: EventHandlers<Connection<BrowserElement>>): void;
    /**
     * Drags a connection from the given endpoint or element, but aborts the operation by triggering a mouseup in whitespace.
     * @param d1
     * @public
     */
    dragAndAbortConnection(d1: BrowserElement | Endpoint<BrowserElement>): void;
    /**
     ...
     * @public
     */
    detachConnection(e: Endpoint<BrowserElement>, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    detachAndReattachConnection(e: Endpoint<BrowserElement>, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    detachConnectionByTarget(c: Connection<BrowserElement>, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    relocateTarget(conn: Connection<BrowserElement>, newEl: BrowserElement, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    relocate(conn: Connection<BrowserElement>, idx: number, newEl: BrowserElement, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    relocateSource(conn: Connection<BrowserElement>, newEl: BrowserElement, events?: EventHandlers): void;
    /**
     ...
     * @public
     */
    makeEvent(el: BrowserElement): any;
    /**
     ...
     * @public
     */
    getEndpointCanvas(ep: Endpoint<BrowserElement>): HTMLElement;
    /**
     * Gets the DOM element used to represent the given connection.
     * @param c
     * @public
     */
    getConnectionCanvas(c: Connection<BrowserElement>): BrowserElement;
    getEndpointCanvasPosition(ep: Endpoint<BrowserElement>): {
        x: number;
        y: number;
        w: string;
        h: string;
     ...
     * @public
     */
    assertManagedEndpointCount(el: BrowserElement, count: number): void;
    /**
     ...
     * @public
     */
    assertManagedConnectionCount(el: BrowserElement, count: number): void;
    /**
     ...
     * @public
     */
    fireEventOnEndpoint(ep: Endpoint<BrowserElement>, ...events: Array<string>): void;
    /**
     ...
     * @public
     */
    fireEventOnElement(e: BrowserElement, ...events: Array<string>): void;
    /**
     ...
     * @public
     */
    fireEventOnConnection(connection: Connection<BrowserElement>, ...events: Array<string>): void;
    /**
     * Fire a click event on the DOM element that represents the given connection.
     * @param connection
     * @public
     */
    clickOnConnection(connection: Connection<BrowserElement>): void;
    /**
     * Fire a double click event on the DOM element that represents the given connection.
     * @param connection
     * @public
     */
    dblClickOnConnection(connection: Connection<BrowserElement>): void;
    /**
     * Fire a tap event on the DOM element that represents the given connection.
     * @param connection
     * @public
     */
    tapOnConnection(connection: Connection<BrowserElement>): void;
    /**
     * Fire a double tap event on the DOM element that represents the given connection.
     * @param connection
     * @public
     */
    dblTapOnConnection(connection: Connection<BrowserElement>): void;
    /**
     ...
     * @public
     */
    clickOnElement(element: BrowserElement, clickCount?: number): void;
    /**
     * Fire a double click event on the given element
     * @param element
     * @public
     */
    dblClickOnElement(element: BrowserElement): void;
    /**
     * Fire a tap event (mousedown + mouseup) on the given element
     * @param element
     * @public
     */
    tapOnElement(element: BrowserElement): void;
    /**
     * Fire a double tap event (mousedown + mouseup, twice) on the given element
     * @param element
     * @public
     */
    dblTapOnElement(element: BrowserElement): void;
    /**
     ...
     * @public
     */
    fireEventOnOverlay(connection: Connection<BrowserElement>, overlayId: string, event: string): void;
    /**
     ...
     * @public
     */
    clickOnOverlay(connection: Connection<BrowserElement>, overlayId: string): void;
    /**
     ...
     * @public
     */
    dblClickOnOverlay(connection: Connection<BrowserElement>, overlayId: string): void;
    /**
     ...
     * @public
     */
    tapOnOverlay(connection: Connection<BrowserElement>, overlayId: string): void;
    /**
     ...
     * @public
     */
    dblTapOnOverlay(connection: Connection<BrowserElement>, overlayId: string): void;
    /**
