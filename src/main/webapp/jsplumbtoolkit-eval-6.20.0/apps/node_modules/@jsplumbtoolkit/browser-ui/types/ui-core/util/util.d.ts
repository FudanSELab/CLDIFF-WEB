 ...
 * @param o
 */
export declare function isTextNode(o: any): boolean;
/**
...
export declare function translateRect(p1: RectangleXY, delta: PointXY, dir: 1 | -1): RectangleXY;
/**
...
/**
 * A helper class that can track
 */
export declare class ExtentsManager {
    private extents;
    constructor();
    add(position: PointXY, size: Size): ExtentsManager;
    addAll(entries: Array<RectangleXY>): ExtentsManager;
    reset(): void;
    getExtents(): Extents;
}
