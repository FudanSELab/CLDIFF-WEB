...
/**
 * UI fires this event when a connection is being dragged
 * @internal
 */
export declare const EVENT_CONNECTION_DRAGGING = "connection:dragging";
/**
 * UI fires this event when a connection has just been dragged
 * @internal
 */
export declare const EVENT_CONNECTION_DRAG_END = "connection:drag:end";
/**
 * @public
 */
