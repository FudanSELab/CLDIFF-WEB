...
export declare type IntersectingGroup = {
    ...
    d: number;
    intersectingElement: BrowserElement;
};
export declare type GroupLocation = {
    el: BrowserElement;
    r: BoundingBox;
    group: UIGroup<BrowserElement>;
};
...
export declare class ElementDragHandler implements DragHandler {
    ...
    /**
     * TODO this method can be removed, it is unused.
     * @internal
     */
    setDragGroupState(active: boolean, ...els: Array<BrowserElement>): void;
    /**
     * @internal
     * @param name
     */
     ...
     * @param mustPruneOrOrphan Used internally, when an element has been dragged on purpose out of an elastic group.
     * @internal
     */
