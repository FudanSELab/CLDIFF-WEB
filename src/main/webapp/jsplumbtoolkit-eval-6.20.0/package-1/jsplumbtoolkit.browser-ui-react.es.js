...
import { MiniviewPlugin, render, extend, EVENT_NODE_UPDATED, EVENT_GROUP_UPDATED, EVENT_NODE_REMOVED, EVENT_GROUP_REMOVED, EVENT_GRAPH_CLEARED, ElementTypes, svg, ELEMENT_SVG, log, BrowserUIBase, DropManager, SurfaceDropManager, ShapeLibraryPalette, EdgeTypePicker, SurfaceMode, EVENT_UNDOREDO_UPDATE, TRUE, FALSE } from '@jsplumbtoolkit/browser-ui';
  ...
  return _createClass(JsPlumbToolkitSurfaceComponent, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.mounted) {
        ...
        var templateRenderer = {
          ...
          render: function render(id, data, toolkit, type, surface, def, modelObject, node, eventInfo) {
            if (def.component || def.jsx) {
              var d = surface.jsplumb.containerType === ElementTypes.HTML ? document.createElement(DIV) : svg.node(ELEMENT_SVG);
              ...
              log("WARN: `component` not set for node/group - falling back to default template renderer with template " + id + ". Consider mapping a React component or some jsx in your view.");
            }
          },
        ...
        this.surface = render(this.toolkit, this._container, templateRenderer, extend(this.renderParams, {
          view: this.view
        }));
    ...
    value: function _generateComponent(ns) {
      var _this3 = this;
      return /*#__PURE__*/React.createElement(JSXWrapper, {
        ns: ns,
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/ReactDOM.createPortal(_this4._generateComponent(ns), ns.domElement, ns.key);
      }));
    }
...
function JSXWrapper(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, props.ns.def.jsx != null && props.ns.def.jsx({
    vertex: props.ns.node,
    toolkit: props.toolkit,
    surface: props.surface,
    data: props.ns.node.data,
    props: props.childProps || {}
  }), props.ns.def.component != null && /*#__PURE__*/React.createElement(props.ns.def.component, props.ns.payload), initialized.current === false && /*#__PURE__*/React.createElement("div", {
    ref: placeholder
  }));
}
...
var BrowserUIReact = /*#__PURE__*/function (_BrowserUIBase) {
  ...
  return _createClass(BrowserUIReact, [{
    ...
    value: function render(container, options) {
      log("render called directly on BrowserUIReact class: should not happen. Surface component should use internal render.");
      return null;
    }
  }]);
}(BrowserUIBase);
...
var EdgeTypePickerComponent = /*#__PURE__*/function (_React$Component) {
  ...
  return _createClass(EdgeTypePickerComponent, [{
    ...
    value: function componentDidMount() {
      var _this3 = this;
      this.edgeTypePicker = new EdgeTypePicker(this.inspector.toolkit, this._container, this.edgeMappings, this.inspector.getValue(this.propertyName), function (v) {
...
var ControlsComponent = /*#__PURE__*/function (_React$Component) {
  function ControlsComponent(props) {
    ...
    _this.toolkit.bind(EVENT_UNDOREDO_UPDATE, function (state) {
      _this._container.setAttribute(ATTRIBUTE_CAN_UNDO, state.undoCount > 0 ? TRUE : FALSE);
      _this._container.setAttribute(ATTRIBUTE_CAN_REDO, state.redoCount > 0 ? TRUE : FALSE);
    });
    return _this;
  }
...
export { BaseGroupComponent, BaseNodeComponent, BasePortComponent, BaseVertexComponent, BrowserUIReact, ControlsComponent, EdgeTypePickerComponent, JsPlumbToolkitDragDropComponent, JsPlumbToolkitMiniviewComponent, JsPlumbToolkitSurfaceComponent, ShapeComponent, ShapeLibraryPaletteComponent, SurfaceDropComponent, newInstance };
