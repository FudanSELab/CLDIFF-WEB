...
import { JsPlumbDefaults, UICoreOptions } from "../core/defaults";
...
export interface BrowserJsPlumbOptions extends UICoreOptions<BrowserElement> {
 ...
 * @public
 */
export interface BrowserJsPlumbDefaults extends JsPlumbDefaults<BrowserElement> {
    /**
    ...
    /**
     * Defaults to false, which is a breaking change in 6.6.0. When true, jsPlumb tracks mouseover/mouseout/mouseenter/mouseexit events for
     * overlays, endpoints, elements and connections. Most of the reasoning for having this ability was related to the initial canvas renderer,
     * and with SVG/CSS this functionality is, for the most part, not needed. But you can switch it on if you need to.
     * @since 6.6.0
     */
    hoverEvents?: boolean;
...
export interface jsPlumbDOMInformation {
    connector?: Connector;
    endpoint?: Endpoint<jsPlumbDOMElement>;
    overlay?: Overlay;
}
/**
...
/**
 * JsPlumbInstance that renders to the DOM in a browser, and supports dragging of elements/connections. Not public facing, as
 * the surface wraps this.
 * @internal
 */
export declare class BrowserJsPlumbInstance extends JsPlumbInstance<{
    ...
    constructor(toolkit: JsPlumbToolkit, options: BrowserJsPlumbOptions, defaults?: BrowserJsPlumbDefaults);
    /**
     ...
     * @internal
     */
    _getAssociatedElements(el: BrowserElement): Array<BrowserElement>;
    /**
     * Gets the CSS class for the given element.
     * @param el
     * @public
     */
    getClass(el: BrowserElement): string;
    /**
     ...
     * @public
     */
    addClass(el: BrowserElement | NodeListOf<BrowserElement>, clazz: string): void;
    /**
     ...
     * @public
     */
    hasClass(el: BrowserElement, clazz: string): boolean;
    /**
     ...
     * @public
     */
    removeClass(el: BrowserElement | NodeListOf<BrowserElement>, clazz: string): void;
    /**
     ...
     * @public
     */
    toggleClass(el: BrowserElement | NodeListOf<BrowserElement>, clazz: string): void;
    /**
     ...
     * @public
     */
    on(el: Document | Element | BrowserElement | NodeListOf<BrowserElement>, event: string, callbackOrSelector: Function | string, callback?: Function): this;
    /**
     ...
     * @public
     */
    off(el: Document | Element | BrowserElement | NodeListOf<BrowserElement>, event: string, callback: Function): this;
    /**
     ...
     * @public
     */
    trigger(el: Document | Element | BrowserElement, event: string, originalEvent?: Event, payload?: any, detail?: number): void;
    /**
    ...
    /**
     * Exposed on this class to assist core in abstracting out the specifics of the renderer.
     * TODO only used by the drawing tools plugin currently.
     * @internal
     * @param el
     */
    getInternalSize(el: Element): Size;
    /**
     * Exposed here for Collicat, it needs an object with a getPosition method. otherwise not needed.
     ...
     * @param group
     */
    getGroupContentArea(group: UIGroup<any>): jsPlumbDOMElement;
    /**
     * Exposed on this class to assist core in abstracting out the specifics of the renderer.
     * @internal
     ...
     * @public
     */
    setDraggable(element: BrowserElement, draggable: boolean): void;
    /**
     ...
     * @public
     */
    unmanage(el: BrowserElement, removeElement?: boolean): void;
    /**
     * Adds the given element(s) to the current drag selection.
     * @param el
     * @public
     */
    addToDragSelection(...el: Array<BrowserElement>): void;
    /**
     ...
     * @public
     */
    removeFromDragSelection(...el: Array<BrowserElement>): void;
    /**
     * Toggles membership in the current drag selection of the given element(s)
     * @param el
     * @public
     */
    toggleDragSelection(...el: Array<BrowserElement>): void;
    /**
     ...
     * @public
     */
    addToDragGroup(spec: DragGroupSpec, ...els: Array<BrowserElement>): void;
    /**
     ...
     * @public
     */
    removeFromDragGroup(...els: Array<BrowserElement>): void;
    /**
     ...
     * @public
     */
    setDragGroupState(state: boolean, ...els: Array<BrowserElement>): void;
    /**
     ...
     * @public
     */
    rotate(element: BrowserElement, rotation: number, doNotRepaint?: boolean): RedrawResult;
    svg: {
     ...
     * @param c
     */
    reattachOverlay(o: Overlay, c: Connection<Element>): void;
    /**
     * @internal
     * @param o
     * @param hover
     ...
     */
    drawOverlay(o: Overlay, component: Connector, paintStyle: PaintStyle, absolutePosition?: PointXY): any;
    /**
     * @internal
     * @param o
     */
     ...
     * @param hover
     */
    setHover(component: ComponentBase, hover: boolean): void;
    /**
     * Set the current zoom. Override from base class to inform drag manager.
     * @param zoom
     */
    setZoom(zoom: number, repaintEverything?: boolean): boolean;
    /**
     * @internal
     * @param connector
     * @param paintStyle
     * @param extents
     */
    paintConnector(connector: Connector, paintStyle: PaintStyle, extents?: Extents): void;
    /**
     * @internal
     * @param connector
     * @param hover
     ...
     */
    setConnectorHover(connector: Connector, hover: boolean, sourceEndpoint?: Endpoint<Element>): void;
    /**
     * @internal
     * @param connection
     */
     ...
     * @param t
     */
    applyConnectorType(connector: Connector, t: TypeDescriptor): void;
    /**
     * @internal
     * @param ep
     * @param c
     */
    addEndpointClass(ep: Endpoint<Element>, c: string): void;
    /**
     * @internal
     * @param ep
     * @param t
     */
    applyEndpointType<C>(ep: Endpoint<Element>, t: TypeDescriptor): void;
    /**
     * @internal
     * @param ep
     */
    destroyEndpoint(ep: Endpoint<BrowserElement>): void;
    /**
     * @internal
     * @param ep
     * @param paintStyle
     */
    renderEndpoint(ep: Endpoint<BrowserElement>, paintStyle: PaintStyle): void;
    /**
     * @internal
     * @param ep
     * @param c
     */
    removeEndpointClass(ep: Endpoint<BrowserElement>, c: string): void;
    /**
     * @internal
     * @param ep
     */
    getEndpointClass(ep: Endpoint<BrowserElement>): string;
    /**
     * @internal
     * @param endpoint
     * @param hover
     ...
     * @param doNotCascade
     */
    setEndpointHover(endpoint: Endpoint<BrowserElement>, hover: boolean, endpointIndex: -1 | 0 | 1, doNotCascade?: boolean): void;
    /**
     * @internal
     * @param ep
     * @param v
     */
    setEndpointVisible(ep: Endpoint<Element>, v: boolean): void;
    /**
     * @internal
     * @param group
     * @param state
     */
    setGroupVisible(group: UIGroup<BrowserElement>, state: boolean): void;
    /**
     * @internal
     * @param connection
     * @param params
     */
    deleteConnection(connection: Connection<BrowserElement>, params?: DeleteConnectionOptions): boolean;
    /**
     ...
     */
    manage(element: BrowserElement, internalId?: string, _recalc?: boolean): ManagedElement<BrowserElement>;
