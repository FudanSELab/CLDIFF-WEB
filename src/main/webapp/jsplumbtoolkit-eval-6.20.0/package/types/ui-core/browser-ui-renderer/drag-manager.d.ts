...
export declare const CLASS_DRAG_ORIGINAL_GROUP = "jtk-drag-original-group";
...
/**
 * Manages element + edge dragging for an instance of the Browser UI.
 *
 * This class maintains a reference to a BrowserUI instance and an underlying Collicat, which is the low level
 * manager for DOM element dragging.
 *
 * @internal
 */
