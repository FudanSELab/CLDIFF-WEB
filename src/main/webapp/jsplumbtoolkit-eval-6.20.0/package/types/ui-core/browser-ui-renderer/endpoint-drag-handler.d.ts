...
import { EndpointRepresentation } from "../core/endpoint/endpoint-representation";
...
export declare class EndpointDragHandler implements DragHandler {
    ...
    jpc: Connection<BrowserElement>;
    existingJpc: boolean;
    private _originalAnchorSpec;
    ep: Endpoint<BrowserElement>;
    ...
    floatingId: string;
    floatingElement: BrowserElement;
    floatingEndpoint: Endpoint<BrowserElement>;
    ...
    payload: any;
    floatingConnections: Record<string, Connection<BrowserElement>>;
