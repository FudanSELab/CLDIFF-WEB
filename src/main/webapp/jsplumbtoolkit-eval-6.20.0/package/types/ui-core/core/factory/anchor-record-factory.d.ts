...
export declare enum FaceValues {
    top = "top",
    left = "left",
    right = "right",
    bottom = "bottom"
...
export declare class LightweightFloatingAnchor implements LightweightAnchor {
    ...
    size: Size;
    constructor(instance: JsPlumbInstance, ep: Endpoint<Element>, element: Element, elementId: string);
     ...
     */
    over(endpoint: Endpoint<Element>): void;
    /**
